...
//RECUPERATION DES LETTRES DANS MON HTML
        lettreUn = $('#lettreUn').prop("src", "Letters/" + lettreUn + "/" + lettreUn + "1.jpg");
        lettreDeux = $('#lettreDeux').prop("src", "Letters/" + lettreDeux + "/" + lettreDeux + "1.jpg");
        lettreTrois = $('#lettreTrois').prop("src", "Letters/" + lettreTrois + "/" + lettreTrois + "1.jpg");
        lettreQuatre = $('#lettreQuattre').prop("src", "Letters/" + lettreQuatre + "/" + lettreQuatre + "1.jpg");
        lettreCinq = $('#lettreCinq').prop("src", "Letters/" + lettreCinq + "/" + lettreCinq + "1.jpg");
        lettreSix = $('#lettreSix').prop("src", "Letters/" + lettreSix + "/" + lettreSix + "1.jpg");
        lettreSept = $('#lettreSept').prop("src", "Letters/" + lettreSept + "/" + lettreSept + "1.jpg");
        lettreHuit = $('#lettreHuit').prop("src", "Letters/" + lettreHuit + "/" + lettreHuit + "1.jpg");
        lettreHuit = $('#lettreNeuf').prop("src", "Letters/" + lettreNeuf + "/" + lettreNeuf + "1.jpg");
        lettreHuit = $('#lettreDix').prop("src", "Letters/" + lettreDix + "/" + lettreDix + "1.jpg");
        lettreHuit = $('#lettreOnze').prop("src", "Letters/" + lettreOnze + "/" + lettreOnze + "1.jpg");
        lettreHuit = $('#lettreDouze').prop("src", "Letters/" + lettreDouze + "/" + lettreDouze + "1.jpg");
